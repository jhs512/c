...
function MainPage() {
  ...
  return /*#__PURE__*/(
    ...
    React.createElement(Button, { variant: "contained", onClick: recordModalStatus.open }, "\uD0A5 \uD69F\uC218 \uAE30\uB85D\uD558\uAE30"))))));
...
function App() {
  ...
  return /*#__PURE__*/(
    ...
    React.createElement(NavLink, {
      to: "/main",
      className: "font-bold select-none self-stretch flex items-center" }, "\uD0A5 \uCC4C\uB9B0\uC9C0"), /*#__PURE__*/
